...
// import sivaprakash_image from '../../../public/images/sivaprakash_img2.jpeg';
import sivaprakash_image from '../../../public/images/sivaprakash.jpg';
const Intro = () => {
  return (
    <>
      {/* fixed at top */}
      ...
      <Image className='w-[5.7rem] h-[5.7rem] rounded-full' src={sivaprakash_image} alt='profile picture' />
